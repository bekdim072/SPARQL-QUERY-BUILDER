Public Class GroupBy
    ...
    Private Sub GroupBy_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        For Each item As Object In Form1.lstSelectList.Items
    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        ...
        Form1.rtxtQuery.Text = prefixSelect + aggregateSelect + fromWhere + statementsString + closeQuery + groupByString
        Me.Hide()
    End Sub
